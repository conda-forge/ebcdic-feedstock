...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ebcdic-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12755&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ebcdic-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ebcdic` can be installed with:

```
conda install ebcdic
```

It is possible to list all of the versions of `ebcdic` available on your platform with:
